...
export default function CompanyList() {
  ...
  const statusColors = {
    ...
    archived: 'bg-dark-500/20 text-theme-text-muted',
  }
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-theme-text-primary">Firmalar</h1>
          <p className="text-theme-text-muted mt-1">Sistemdeki {companies.length} firma</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredCompanies.map(company => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-theme-text-muted">{company.company_code}</p>
                </div>
              </div>
            ...
            {company.city && (
              <div className="flex items-center gap-2 text-sm text-theme-text-muted mb-4">
                <MapPin size={14} />
      ...
      {filteredCompanies.length === 0 && (
        <div className="text-center py-16 bg-theme-bg-secondary rounded-xl border border-theme-border-primary">
          <Building2 size={48} className="text-theme-text-placeholder mx-auto mb-4" />
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[9999] p-4 overflow-y-auto">
          <div className="bg-theme-bg-secondary rounded-2xl w-full max-w-3xl border border-theme-border-primary h-[80vh] flex flex-col relative animate-fadeIn">
            <div className="p-6 border-b border-theme-border-primary">
              <h2 className="text-xl font-semibold text-theme-text-primary">Genel Bilgiler</h2>
              <p className="text-sm text-theme-text-muted mt-1">Yeni Firma Ekle</p>
            </div>
            <div className="p-6 space-y-4 overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm text-theme-text-tertiary mb-2">Kayıt Tarihi *</label>
                  <input
                    type="date"
